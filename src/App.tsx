    ...
    <div className='min-h-screen bg-darker text-light font-sans selection:bg-primary/30'>
      ...
      >
        <div className='flex items-center gap-12 justify-between md:justify-center glass rounded-full px-8 py-4 shadow-[0_0_40px_rgba(0,0,0,0.3)] border border-white/10 w-[calc(100%-3rem)] md:w-auto'>
          ...
          >
            ...
            <span className='text-primary transition-all group-hover:drop-shadow-[0_0_12px_var(--color-primary)]'>
              S
            </span>
          </motion.a>
          ...
          {/* Desktop Nav */}
          <div
            className='hidden md:flex items-center gap-2 rounded-full relative'
          ...
          <div className='flex items-center gap-2'>
            ...
            <motion.button
              className={`md:hidden text-light p-3 rounded-2xl transition-all flex items-center justify-center ${
                scrolled ? 'bg-white/5' : 'glass'
              }`}
      ...
      >
        ...
        <div className='max-w-7xl mx-auto px-6 relative z-10 text-center'>
          ...
          >
            <span className='text-primary font-mono tracking-widest text-sm uppercase mb-4 block'>
              Hello, I'm
            </span>
            ...
            <p className='text-gray text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed'>
              A creative front-end developer and UI/UX designer with passion for
              building elegant web experiences and interactive interfaces.
            </p>
          ...
          <div className='grid lg:grid-cols-2 gap-16 lg:gap-24 items-center'>
            ...
            >
              ...
              <div className='aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl relative z-10 bg-dark/50 border border-white/5 group-hover:border-primary/30 transition-colors duration-500'>
                ...
                <motion.div className='absolute bottom-6 left-6 right-6 p-4 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-between shadow-xl backdrop-blur-md translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 delay-100'>
                  <div>
                ...
                <div className='absolute top-6 right-6 opacity-0 group-hover:opacity-100 transition-all duration-500 delay-200 -translate-y-4 group-hover:translate-y-0'>
                  <a
                    ...
                    className='flex items-center justify-center w-12 h-12 bg-white/10 hover:bg-white text-white hover:text-dark rounded-full backdrop-blur-md border border-white/20 transition-all duration-300'
                  >
                    <Github size={22} />
                  </a>
                </div>
            ...
            <div className='relative'>
              ...
              >
                ...
                <p className='text-gray text-lg mb-6 leading-relaxed'>
                  "I'm Ahmed — a front-end developer and UI/UX designer with 2
                  years of hands-on experience building products that people
                  actually enjoy using. I've had the privilege of partnering
                  with 13 clients across different industries, turning ideas
                  into polished digital experiences — from early wireframes to
                  pixel-perfect production code. My work sits at the
                  intersection of design thinking and clean engineering: every
                  interface I ship is purposeful, accessible, and built to last
                  — backed by 1,200+ hours of real-world client work."
                </p>
              </motion.div>
              ...
              >
                {[
                  ...
                  >
                    ...
                    <div>
                      <p className='text-xs text-gray/60 uppercase tracking-wider mb-1'>
                        {info.label}
                      </p>
          ...
          <div className='grid md:grid-cols-3 gap-8'>
            {[
              ...
              >
                ...
                <div
                  className={`absolute inset-0 bg-linear-to-br ${ach.bg} to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none`}
                />
                ...
                <div className='relative z-10'>
                  ...
                  <p className='text-gray leading-relaxed font-light group-hover:text-white/80 transition-colors duration-300'>
                    {ach.desc}
                  </p>
                </div>
            ...
            {[
              ...
              >
                ...
                <div className='p-6 flex flex-col flex-grow'>
                  ...
                  <p className='text-gray text-sm mb-6 flex-grow'>
                    {project.desc}
                  </p>
                  <div className='flex flex-wrap gap-2'>
                    {project.tags.map(tag => (
                      <span
                        key={tag}
                        className='text-[10px] uppercase tracking-wider font-bold px-2 py-1 bg-white/5 rounded-md border border-white/5'
                      >
                        {tag}
                      </span>
                    ))}
        ...
        <div className='max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8'>
          <div className='text-center md:text-left'>
            ...
            <p className='text-gray text-sm'>
              © 2025 Ahmed Shaker. All Rights Reserved.
            </p>
          </div>
          ...
          <div className='flex gap-4'>
            <SocialLink
              ...
              href='https://www.linkedin.com/in/axshaker'
            />
            <SocialLink
              icon={<Github size={20} />}
              href='https://github.com/AhmdShakerx'
            ...
            <div className='flex justify-between items-end mb-3'>
              ...
              <div className='overflow-hidden h-6'>
                <div className='flex flex-col group-hover/skill:-translate-y-1/2 transition-transform duration-500'>
                  <span className='text-gray/50 font-mono text-sm h-6 flex items-center justify-end'>
                    {skill.level}%
                  </span>
                  <span className='text-primary font-mono text-sm h-6 flex items-center justify-end font-bold'>
                    {skill.level}%
                  </span>
                </div>
              </div>
